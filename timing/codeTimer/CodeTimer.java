...
public abstract class CodeTimer {
    ...
    public CodeTimer() {
        ...
        if (settings != null) {
            ...
            System.out.print(settings.title() + "\n");
            System.out.print(settings.titleY() + "\t" + settings.titleX() + "\n");
        }
    ...
    public void output(int step, double avgTime) {
        if (printSteps) {
            System.out.print(step + "\t" + String.format("%.3f", avgTime/100) + "\n");
        } else {
            System.out.print(String.format("%.3f", avgTime/1000) + "\n");
        }
    }
