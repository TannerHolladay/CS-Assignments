...
public class SpellCheckerDemo {
	...
	public static void main(String[] args) {
		...
		SpellChecker mySC = new SpellChecker(new File("src/src/assign08/dictionary.txt"));

		runSpellCheck(mySC, "src/src/assign08/hello_world.txt");
		runSpellCheck(mySC, "src/src/assign08/good_luck.txt");
	}
